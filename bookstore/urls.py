...
urlpatterns = [
    ...
    path('book/<int:pk>/details/', views.BookDetailsView.as_view(), name='details_book'),
    ...
    path('staff/view_books/', views.ViewBook.as_view(), name='staff_book_view'),
    path('book/<int:book_id>/add_more_info/', views.add_book_more_info, name='add_book_more_info'),
    path('staff/view_stock/', views.ViewStock.as_view(), name='view_stock'),
